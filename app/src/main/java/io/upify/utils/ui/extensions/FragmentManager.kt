...
fun FragmentManager.showFragment(fragment: Fragment, parent: Int, type: FragmentAnim = FragmentAnim.TYPE_NO_ANIMATION, tag: String? = null){
...
fun FragmentManager.remove(fragment: Fragment, fromBackStack: Boolean = false){
    if (fromBackStack){
